...
describe('Reservation Controller', () => {
  ...
  // Tests for createReservation (4 tests)
  describe('createReservation', () => {
    it('should create reservations successfully', async () => {
      ...
      expect(mockProduct.quantite_stock).toBe(3); // 5 - 2
    ...
    it('should return 400 if required fields are missing', async () => {
      mockReq.body = {
        items: [{ productId: 'product1', userId: 'user1', quantity: 2 }], // Missing name, email, address
      };
  ...
  // Tests for getAllReservations (2 tests)
  ...
  // Tests for getOrdersByVendor (1 test)
